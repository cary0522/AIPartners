...
function getInfo() {
    ...
    function Partner(appearance, trait) {
        this.appearance = appearance;
        this.trait = trait
    }

    let AiPartner = new Partner(partnerAppearanceArr, partnerTraitArr);
    ...
    fetch('http://127.0.0.1/AIpartner/AIpartners.php', {
        ...
        photo.innerHTML = `<img src='data:image/png;base64, ${res['image']}' alt=''>`
        interactivePartnerPhoto.innerHTML =
            `<img src="data:image/png;base64, ${res['image']}" alt="" class="rounded-circle flex-shrink-0">`
        let feedback = [];
